...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Для Каждого ТекСтрока из СписокСотрудников Цикл
		...
		ДвижениеДопНачисления.ВидРасчета = ПланыВидовРасчета.ВКМ_ДополнительныеНачисления.ФиксированнаяПремия;
		ДвижениеДопНачисления.ПериодРегистрации = Дата;
		ДвижениеДопНачисления.Сотрудник = ТекСтрока.Сотрудник;
		ДвижениеДопНачисления.Результат = ТекСтрока.СуммаПремии;
		...
		ДвижениеУдержания.Результат = СуммаНДФЛ;
