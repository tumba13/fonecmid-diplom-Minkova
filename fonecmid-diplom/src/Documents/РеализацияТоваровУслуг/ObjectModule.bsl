...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	// Минкова - Автозаполнения документа с договором абонентского обслуживания - 29.05.2025
...
Функция ВКМ_ДовавитьДвиженияВРегистрВыставленныеЗаРаботыАкты()
	...
	Если ВидДоговора = Перечисления.ВидыДоговоровКонтрагентов.ВКМ_АбонентскоеОбслуживание Тогда
		...
		Если Не ЗначениеЗаполнено(АбонентскаяПлата) Или Не ЗначениеЗаполнено(РаботыСпециалиста) Тогда
			...
			Сообщение.Текст = "Необходимо проверить заполнение констант ВКМ_НоменклатураАбонентскаяПлата и ВКМ_НоменклатураРаботыСпециалиста";
			Сообщение.Сообщить();
			Отказ = Истина;
		КонецЕсли;
